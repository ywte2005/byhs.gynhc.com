...
CREATE TABLE `fa_admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8mb4 COMMENT='管理员日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_auth_rule` (
  ...
  KEY `pid` (`pid`),
  KEY `weigh` (`weigh`)
) ENGINE=InnoDB AUTO_INCREMENT=306 DEFAULT CHARSET=utf8mb4 COMMENT='节点表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_merchant` (
  ...
  `type` enum('personal','enterprise') NOT NULL DEFAULT 'personal' COMMENT '商户类型',
...
CREATE TABLE `fa_user_bankcard` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='用户银行卡表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `fa_user_bankcard` VALUES (1,2,'中国工商银行','','1111111111111111','1','',1,'normal',1770528351,1770528351);
...
-- Dump completed on 2026-02-08 13:30:45
